  ...
  return (
    <div className="App">
      ...
      <div className="task-box">
        <h2>テストの概要</h2>
        <p>
          本テスト用に能力の低い接客ロボットが受付業務をしている動画をご用意しました。動画を視聴して、ロボットが受付業務で<b><u>顧客満足度全国No.1（患者に寄り添った最高品質のロボット接客）</u></b>を勝ち取ることを目指す上で、足りないポイントについての提案をしてください。
        </p>
        <p>
          動画では、調剤薬局の入り口近くに設置された接客ロボットが、患者受付の業務をしている状況です。接客ロボットは、薬剤師が服薬指導をする前の全ての業務を担うために設置されています。しかしながら、<b><u>動画中の接客ロボットは、決められた最低限の業務を行うことしかできず、患者に寄り添った接客ができていないことが課題</u></b>であり、患者満足度の向上に繋がっていない状況です。
        </p>
        <p>
          そこで、このロボットが患者に寄り添った最高品質の接客を実現するために、<b><u>「自分であればロボットにどのように接客をさせるか」</u></b>という提案を行ってください。提案内容は、どのような「状況」で、ロボットがどんな「推奨行動」を行うべきかを記述してください。補足説明が必要であれば、追加で記述してください。
        </p>
        <div>
        <b>提案例：</b>
          <ul>
      ...
      <div className="task-box">
        <h2>接客ロボットの受付フロー</h2>
        <p>
          接客ロボットは、下記の流れに従って、薬剤師が服薬指導をする前の全ての業務を担うために設置されています。ロボットは発話とディスプレイ表示によって患者に指示を出し、患者は発話もしくはタッチパネルのボタンで、コミュニケーションを取ることができます。
        </p>
        <ol>
            <li><b>受付の開始：</b> 患者が目の前に立つと、受付業務を開始します。</li>
            <li><b>処方箋：</b> 患者に処方箋のスキャンを促します。患者はスキャンが完了したことを伝えます。</li>
            <li><b>保険証/マイナンバーカード：</b> 患者に保険証/マイナンバーカードのスキャンを促します。患者はスキャンが完了したことを伝えます。</li>
      ...
      <div className="task-box">
        ...
        <div>
          ...
          <ul>
            ...
            <li><b>認識能力：</b>ロボットの映像と音声の認識能力は、人間と同等のレベルであるものとします（患者が歩いている、困っている、呟いた、等）。</li>
            <li><b>受付方法：</b>ロボットからの問いかけに対して、患者はタッチパネルで回答することも、発言して回答することもできます。</li>
            <li><b>業務知識：</b>ロボットは、業務に関連する知識はすべて持っているものとします。</li>
          </ul>
        </div>
      </div>
      ...
      <div className="task-box">
        ...
        <div>
          ...
          <ol>
            ...
            <li> <b>提案フォームに記入：</b>接客内容を提案するフォームが出てくるので、「状況」「推奨行動」ついて詳細に記入してください。「備考欄」は補助的な説明が必要な場合のみ記入してください。記入後に「保存」ボタンを押すと、ページ下部の接客提案一覧に、回答内容が保存されていることを確認してください。回答を修正したい場合は、保存した回答をクリックすることで修正をすることができます。</li>
            <li> <b>1~3を繰り返す：</b>上記の流れを繰り返し、<b>ロボットの接客提案を思いつく限り、多く提案してください</b>。一度提案した内容でも、似たような状況が再度起きた場合には再度記入してください。
</li>
            <li> <b>動画全体を通した共通提案：</b>動画全体を通して同様の提案がある場合は、再生時間を「0:00」の時点で止めて、共通の接客提案として記入することも可能です。</li>
            <li> <b>「テスト終了」ボタンでファイルダウンロード：</b>全ての接客提案を記入し終えたら、「テスト終了」ボタンを押すと、「annotations_(時刻).jsonl」というファイルがダウンロードされます。jsonlファイルの中身は確認できなくても問題ありません。</li>
